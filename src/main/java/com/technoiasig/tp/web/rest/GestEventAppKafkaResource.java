...
@RestController
@RequestMapping("/api/gest-event-app-kafka")
public class GestEventAppKafkaResource {
    private final Logger log = LoggerFactory.getLogger(GestEventAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GestEventAppKafkaResource(KafkaProperties kafkaProperties) {
